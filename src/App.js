...
<Routes>
        ...
        <Route path="/StateObjectWithHooks" element={<StateObjectWithHooks/>} />
        <Route
          path="/useparams/:name/:email/:pass/:add/:about"
          element={<Useparams />}
        />
        ...
        <Route path="/nestedroute/" element={<Nestedexp/>}>
          ...
          <Route path="editprofile" element={<EditProfile />} />
          <Route path="setting" element={<Setting />} />
          <Route path="setting/EditNor/:nor_id/:nor_name/:nor_shortcode/:nor_email/:nor_mobile" element={<EditNor />} />
